          ...
          <div class="card mb-4">
            ...
            <div class="card-body">
              <form action="../controller/create.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="input-group flex-nowrap mb-3">
                  <input type="text" class="form-control" placeholder="kategori" aria-label="kategori" name="kategori"
                    aria-describedby="addon-wrapping">
                </div>
                <div class="input-group flex-nowrap mb-3">
                ...
                <div class="form-floating mb-3">
                  <textarea class="form-control" placeholder="isi artikel" id="floatingTextarea" name="deskripsi"></textarea>
